class DetailView < UIScrollView
  ...
  def init
    super.tap do |ov|
      ...
      ov.addSubview(directors_label = Detail::MovieGenreView.initWithMovie(@movie, genre_label))
      ov.addSubview(actor_label = Detail::MovieGenreView.initWithMovie(@movie, directors_label))
      ov.addSubview(plot_label = Detail::MovieGenreView.initWithMovie(@movie, actor_label))
